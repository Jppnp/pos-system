...
describe('Workflow Integration Tests', () => {
  ...
  describe('Complete Sales Workflow', () => {
    it('should handle search → add to cart → checkout workflow', async () => {
      // Setup test products
      ...
      // Initialize search engine with the new products
    ...
    it('should handle draft management workflow', async () => {
      ...
      // Initialize search engine with the new product
      await searchEngine.initialize()
  ...
  describe('Offline/Online Sync Operations', () => {
    it('should work offline and sync when coming back online', async () => {
      ...
      // Wait for products to load into search engine
      await waitFor(async () => {
      ...
      const searchInput = screen.getByPlaceholderText('ค้นหาและเพิ่มสินค้า...')
